...
export function deflectSmallArmsRound(game,shell,target,point,hitNormal,visible=true){
 ...
 game.hurt(target,shell.damage*.15,shell.owner);if(visible){if(game.fx.ricochet)game.fx.ricochet(point,normal,reflected);else game.fx.muzzle(point,normal);}return true;
}
