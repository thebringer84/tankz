...
- Light patrol jeep enemies, each with a visible driver and gunner. All 25 jeeps start the match, distributed across the expanded battlefield; each has 100 HP, and its machine gun fires roughly eight rounds per second for only 1.2 damage per hit. Direct main-gun hits destroy jeeps.
