...
try{await page.goto('http://localhost:5173');await page.waitForFunction(()=>window.tankz?.game?.running);await page.evaluate(()=>tankz.game.selectTank('scout'));await page.waitForTimeout(900);
